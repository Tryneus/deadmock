...
// TODO: autogenerate these
const legacyIcons = [
  'legacy/hero/abrams/siphon_life_v1',
  'legacy/hero/abrams/shoulder_charge_v1',
  'legacy/hero/abrams/infernal_resilience_v1',
  'legacy/hero/abrams/seismic_impact_v1',
  'legacy/hero/bebop/exploding_uppercut_v1',
  'legacy/hero/bebop/sticky_bomb_v1',
  'legacy/hero/bebop/hyper_beam_v1',
  'legacy/hero/dynamo/kinetic_pulse_v1',
  'legacy/hero/dynamo/quantum_entanglement_v1',
  'legacy/hero/dynamo/rejuvenating_aurora_v1',
  'legacy/hero/dynamo/singularity_v1',
  'legacy/hero/grey_talon/charged_shot_v1',
  'legacy/hero/grey_talon/rain_of_arrows_v1',
  'legacy/hero/grey_talon/spirit_snare_v1',
  'legacy/hero/grey_talon/guided_owl_v1',
  'legacy/hero/haze/sleep_dagger_v1',
  'legacy/hero/haze/smoke_bomb_v1',
  'legacy/hero/haze/fixation_v1',
  'legacy/hero/haze/bullet_dance_v1',
  'legacy/hero/infernus/catalyst_v1',
  'legacy/hero/infernus/flame_dash_v1',
  'legacy/hero/infernus/afterburn_v1',
  'legacy/hero/infernus/concussive_combustion_v1',
  'legacy/hero/ivy/kudzu_bomb_v1',
  'legacy/hero/ivy/watchers_covenant_v1',
  'legacy/hero/ivy/stone_form_v1',
  'legacy/hero/ivy/air_drop_v1',
  'legacy/hero/kelvin/frost_grenade_v1',
  'legacy/hero/kelvin/ice_path_v1',
  'legacy/hero/kelvin/arctic_beam_v1',
  'legacy/hero/kelvin/frozen_shelter_v1',
  'legacy/hero/lady_geist/essence_bomb_v1',
  'legacy/hero/lady_geist/life_drain_v1',
  'legacy/hero/lady_geist/malice_v1',
  'legacy/hero/lady_geist/soul_exchange_v1',
  'legacy/hero/lash/ground_strike_v1',
  'legacy/hero/lash/grapple_v1',
  'legacy/hero/lash/flog_v1',
  'legacy/hero/lash/death_slam_v1',
  'legacy/hero/mcginnis/spectral_wall_v1',
  'legacy/hero/mirage/fire_scarabs_v1',
  'legacy/hero/mirage/djinns_mark_v1',
  'legacy/hero/mirage/traveler_v1',
  'legacy/hero/mo_and_krill/scorn_v1',
  'legacy/hero/mo_and_krill/burrow_v1',
  'legacy/hero/mo_and_krill/sand_blast_v1',
  'legacy/hero/paradox/pulse_grenade_v1',
  'legacy/hero/paradox/time_wall_v1',
  'legacy/hero/paradox/paradoxical_swap_v1',
  'legacy/hero/pocket/barrage_v1',
  'legacy/hero/pocket/flying_cloak_v1',
  'legacy/hero/pocket/enchanters_satchel_v1',
  'legacy/hero/pocket/affliction_v1',
  'legacy/hero/seven/lightning_ball_v1',
  'legacy/hero/seven/static_charge_v1',
  'legacy/hero/seven/power_surge_v1',
  'legacy/hero/seven/storm_cloud_v1',
  'legacy/hero/shiv/serrated_knives_v1',
  'legacy/hero/shiv/slice_and_dice_v1',
  'legacy/hero/shiv/bloodletting_v1',
  'legacy/hero/shiv/killing_blow_v1',
  'legacy/hero/vindicta/stake_v1',
  'legacy/hero/vindicta/flight_v1',
  'legacy/hero/vindicta/crow_familiar_v1',
  'legacy/hero/vindicta/assassinate_v1',
  'legacy/hero/viscous/splatter_v1',
  'legacy/hero/viscous/the_cube_v1',
  'legacy/hero/viscous/puddle_punch_v1',
  'legacy/hero/viscous/goo_ball_v1',
  'legacy/hero/warden/alchemical_flask_v1',
  'legacy/hero/warden/willpower_v1',
  'legacy/hero/warden/binding_word_v1',
  'legacy/hero/warden/last_stand_v1',
  'legacy/hero/wraith/project_mind_v1',
  'legacy/hero/wraith/full_auto_v1',
  'legacy/hero/yamato/power_slash_v1',
  'legacy/hero/yamato/flying_strike_v1',
  'legacy/hero/yamato/crimson_slash_v1',
  'legacy/hero/yamato/shadow_transformation_v1',
];
