...
const ScalingHydrated = {
  ...
  details: {
    ...
    sections: [{
      gridData: {
        cells: [
          {icon: {image: 'stat/ammo'}, value: 0, units: 's', stat: 'Stuff', spiritScaling: 0.5},
          {icon: {image: 'stat/ammo'}, value: 1, units: 's', stat: 'Stuff', meleeScaling: 1.5},
          {icon: {image: 'stat/ammo'}, value: 2, units: 's', stat: 'Stuff', boonScaling: 2.5},
        ],
      },
    }],
  },
...
/* eslint-disable-next-line @stylistic/js/comma-spacing */
const ScalingSerialized = ['ability','Scaling',[],['words',[[[[[['stat/ammo'],'Stuff',0,'s',0,0.5],[['stat/ammo'],'Stuff',1,'s',0,0,0,0,0,1.5],[['stat/ammo'],'Stuff',2,'s',0,0,0,0,0,0,2.5]],[]]]]],['one','two','three']];
...
const snapshots = {
  ...
  Scaling:             {hydrated: ScalingHydrated, serialized: ScalingSerialized},
};
