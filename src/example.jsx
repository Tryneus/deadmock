...
const exampleItem = new ItemState({
  ...
  effects: [{
    ...
    cooldown: 26,
    sections: [
      {type: 'markdown', data: 'Deals **Spirit Damage**, **Slows** targets movement and dashes.  Also **Silences their movement-based items and abilities.**\n_Does not affect target\'s stamina usage._',},
      {type: 'grid', data: {
        cells: [
    ...
    cooldown: 10.5,
    sections: [
      {type: 'markdown', data: 'Imbue an ability with **permanent Spirit Power**.  When that ability is used, gain bonus **Movement Speed**.'},
      {type: 'grid', data: {
        cells: [
          ...
          {icon: {image: "move_speed"}, value: 3, signed: true, units: "m/s", stat: "Move Speed", conditional: true},
        ],
        values: [
